    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'linear-gradient(180deg, #0a0a0a 0%, #111 50%, #0e100f 100%)' }}>
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-neutral-500 text-[11px] font-semibold uppercase tracking-[0.15em] mt-2">{t('auth.slogan')}</p>
        </div>

        <GlowCard>
          <div className="p-8">
            <h2 className="text-xl font-bold text-white tracking-tight mb-6">{t('auth.login')}</h2>
            ...
            <p className="text-center text-xs text-neutral-500 uppercase tracking-wide mt-6">
              {t('auth.noAccount')}{' '}
              <Link to="/register" className="text-accent font-black hover:text-white transition-colors">
                {t('auth.signUp')}
              </Link>
            </p>
          </div>
